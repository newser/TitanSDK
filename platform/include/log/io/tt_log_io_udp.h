...
/**
@file tt_log_io_udp.h
@brief log io udp

this file defines log io udp output
*/

#ifndef __TT_LOG_IO_UDP__
#define __TT_LOG_IO_UDP__
...
tt_export void tt_logio_udp_attr_default(IN tt_logio_udp_attr_t *attr);

#endif /* __TT_LOG_IO_UDP__ */
