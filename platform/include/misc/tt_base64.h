...
//   data_len
extern tt_result_t tt_base64_decode(IN tt_u8_t *data,
                                    IN tt_u32_t data_len,
                                    IN OPT tt_base64_decode_attr_t *attr,
                                    OUT tt_u8_t *decoded,
                                    IN OUT tt_u32_t *decoded_len);

extern tt_result_t tt_base64_decode_alloc(IN tt_u8_t *data,
                                          IN tt_u32_t data_len,
                                          IN OPT tt_base64_decode_attr_t *attr,
                                          OUT tt_u8_t **decoded,
                                          IN OUT tt_u32_t *decoded_len);

extern void tt_base64_decode_attr_default(IN tt_base64_decode_attr_t *attr);
