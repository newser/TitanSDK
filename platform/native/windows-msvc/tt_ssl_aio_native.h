...
@brief ssl aio native

this file defines ssl aio native APIs
*/
...
// test macro
//#define __SIMULATE_SSL_AIO_FAIL
...
typedef tt_u32_t (*tt_ssl_on_decrypt_t)(IN tt_u8_t *pos,
                                        IN tt_u32_t len,
                                        IN void *cb_param);
...
extern void tt_ssl_attr_default_ntv(IN struct tt_ssl_attr_s *attr);
