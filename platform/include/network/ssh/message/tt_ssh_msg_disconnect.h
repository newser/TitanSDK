...
extern struct tt_sshmsg_s *tt_sshmsg_disconnect_create();

extern void tt_sshmsg_disconnect_set_reason(IN struct tt_sshmsg_s *msg,
                                            IN tt_u32_t reason_code);

extern void tt_sshmsg_disconnect_set_desc(IN struct tt_sshmsg_s *msg,
