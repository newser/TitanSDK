...
*/
tt_inline void tt_atomic_s32_set(IN tt_atomic_s32_t *a, IN tt_s32_t val)
{
    tt_atomic_s32_set_ntv(a, val);
}

tt_inline tt_s32_t tt_atomic_s32_swap(IN tt_atomic_s32_t *a, IN tt_s32_t val)
{
    return tt_atomic_s32_swap_ntv(a, val);
}

// return original value
tt_inline tt_s32_t tt_atomic_s32_add(IN tt_atomic_s32_t *a, IN tt_s32_t val)
{
    return tt_atomic_s32_add_ntv(a, val);
}

// return original value
tt_inline tt_s32_t tt_atomic_s32_sub(IN tt_atomic_s32_t *a, IN tt_s32_t val)
{
    return tt_atomic_s32_sub_ntv(a, val);
}
...
@fn tt_result_t tt_atomic_s32_cas(IN tt_atomic_s32_t *a,
                                  ...
                                  IN tt_s32_t val)
compare and set. compare atomic with comparand and exchange with val
...
@param [in] val value to be exchanged with atomic
...
orginal value
*/
tt_inline void tt_atomic_s64_set(IN tt_atomic_s64_t *a, IN tt_s64_t val)
{
    tt_atomic_s64_set_ntv(a, val);
}

tt_inline tt_s64_t tt_atomic_s64_swap(IN tt_atomic_s64_t *a, IN tt_s64_t val)
{
    return tt_atomic_s64_swap_ntv(a, val);
}

tt_inline tt_s64_t tt_atomic_s64_add(IN tt_atomic_s64_t *a, IN tt_s64_t val)
{
    return tt_atomic_s64_add_ntv(a, val);
}

// return original value
tt_inline tt_s64_t tt_atomic_s64_sub(IN tt_atomic_s64_t *a, IN tt_s64_t val)
{
    return tt_atomic_s64_sub_ntv(a, val);
}
...
val if atomic equals comparand
...
orginal pointer
*/
tt_inline void tt_atomic_ptr_set(IN OUT tt_ptr_t *p, IN tt_ptr_t val)
{
    tt_atomic_ptr_set_ntv(p, val);
}

tt_inline tt_ptr_t tt_atomic_ptr_swap(IN tt_ptr_t *a, IN tt_ptr_t val)
{
    return tt_atomic_ptr_swap_ntv(a, val);
}
