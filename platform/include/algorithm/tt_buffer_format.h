...
tt_export tt_result_t tt_buf_put_hex2cstr(IN tt_buf_t *buf, IN tt_u8_t *hex,
                                          IN tt_u32_t hex_len);
...
tt_export tt_result_t tt_buf_putf(IN tt_buf_t *buf, IN const tt_char_t *format,
                                  ...);

tt_export tt_result_t tt_buf_putv(IN tt_buf_t *buf, IN const tt_char_t *format,
                                  IN va_list ap);
