...
extern struct tt_sshmsg_s *tt_sshmsg_servacc_create();

extern void tt_sshmsg_servacc_set_service(IN struct tt_sshmsg_s *msg,
                                          IN tt_ssh_service_t service);

extern tt_ssh_service_t tt_sshmsg_servacc_get_service(
