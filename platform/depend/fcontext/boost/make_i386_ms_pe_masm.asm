...
tt_make_fcontext PROC BOOST_CONTEXT_EXPORT
    ; first arg of tt_make_fcontext() == top of context-stack
    mov  eax, [esp+04h]
    ...
    mov  [eax+014h], ecx
    ; second arg of tt_make_fcontext() == size of context-stack
    mov  edx, [esp+08h]
    ...
    ; third arg of tt_make_fcontext() == address of context-function
    ; stored in EBX
    mov  ecx, [esp+0ch]
    mov  [eax+024h], ecx
    ...
    ; will be entered after calling tt_jump_fcontext() first time
    mov  [eax+02ch], ecx
