...
TT_TEST_CASE("case_sshmsg_byte", "ssh msg parse byte", case_sshmsg_byte, NULL,
             NULL, NULL, NULL, NULL)
,

    TT_TEST_CASE("case_sshmsg_boolean", "ssh msg parse boolean",
                 case_sshmsg_boolean, NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_u32", "ssh msg parse uint32", case_sshmsg_u32,
                 NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_u64", "ssh msg parse uint64", case_sshmsg_u64,
                 NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_string", "ssh msg parse string",
                 case_sshmsg_string, NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_mpint", "ssh msg parse mpint", case_sshmsg_mpint,
                 NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_namelist", "ssh msg parse namelist",
                 case_sshmsg_namelist, NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_parse", "ssh msg parse", case_sshmsg_parse, NULL,
                 NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_disconnect", "ssh msg: disconnect",
                 case_sshmsg_disconnect, NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_ignore", "ssh msg: ignore", case_sshmsg_ignore,
                 NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshms_newkeys", "ssh msg: newkeys", case_sshms_newkeys,
                 NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_servreq", "ssh msg: service request",
                 case_sshmsg_servreq, NULL, NULL, NULL, NULL, NULL),

    TT_TEST_CASE("case_sshmsg_servacc", "ssh msg: service accept",
                 case_sshmsg_servacc, NULL, NULL, NULL, NULL, NULL),
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_boolean)
{
    ...
    ret = tt_buf_get_u8(&buf, &byte);
    TT_UT_SUCCESS(ret, "");
    TT_UT_EQUAL(byte, TT_TRUE, "");

    ret = tt_ssh_boolean_render(&buf, TT_FALSE);
    TT_UT_SUCCESS(ret, "");
    ret = tt_buf_get_u8(&buf, &byte);
    TT_UT_SUCCESS(ret, "");
    TT_UT_EQUAL(byte, TT_FALSE, "");
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_u64)
{
    ...
    TT_UT_SUCCESS(ret, "");
    TT_UT_EQUAL(val, tt_hton64(0x12345678aabbccdd), "");

    // parse
    ret = tt_buf_put_u64_n(&buf, 0x12345678aabbccdd);
    TT_UT_SUCCESS(ret, "");
    ret = tt_ssh_uint64_parse(&buf, &val);
    TT_UT_EQUAL(val, 0x12345678aabbccdd, "");
    TT_UT_EQUAL(TT_BUF_RLEN(&buf), 0, "");
    ...
    ret = tt_ssh_uint64_parse(&buf, &val);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    TT_UT_EQUAL(val, 0x0102030405060708, "");
    TT_UT_EQUAL(TT_BUF_RLEN(&buf), 0, "");
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_string)
{
    ...
    TT_UT_EQUAL(tt_memcmp(cbuf, "12345", 5), 0, "");
    ...
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    TT_UT_EQUAL(len, 10, "");
    TT_UT_EQUAL(tt_memcmp(s, (tt_u8_t *)"123456789a", 10), 0, "");
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_mpint)
{
    ...
    TT_UT_SUCCESS(ret, "");
    TT_UT_EQUAL(len, 12, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 0], 0xFF, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 4], 0x11, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 11], 0x88, "");
    ...
    TT_UT_SUCCESS(ret, "");
    TT_UT_EQUAL(len, 13, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 0], 0x0, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 5], 0x11, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 12], 0x88, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 1], 0xFF, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 5], 0x11, "");
    TT_UT_EQUAL(buf.p[buf.rpos + 12], 0x88, "");
    ...
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    TT_UT_EQUAL(len, 10, "");
    TT_UT_EQUAL(tt_memcmp(cbuf, s, 10), 0, "");
...
tt_result_t __nl_cb(IN tt_char_t *name, IN tt_u32_t name_len, IN void *param)
{
    ...
    if (param == NULL) return TT_FAIL;

    nm = ((struct __nl_cb_param *)param)
             ->name[((struct __nl_cb_param *)param)->idx];
    ((struct __nl_cb_param *)param)->idx += 1;

    if (name_len != (tt_u32_t)tt_strlen(nm)) { return TT_FAIL; }
    if (tt_strncmp(nm, name, name_len) != 0) { return TT_FAIL; }
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_namelist)
{
    ...
    // 1 name
    {
        ...
        TT_UT_EQUAL(ret, TT_SUCCESS, "");
        TT_UT_EQUAL(tt_memcmp(addr, nl[0], 5), 0, "");
        TT_UT_EQUAL(TT_BUF_RLEN(&buf), 0, "");
    }
    ...
    // 2 name
    {
        ...
        TT_UT_EQUAL(ret, TT_SUCCESS, "");
        TT_UT_EQUAL(tt_memcmp(addr, "name1,another name", 5), 0, "");
        TT_UT_EQUAL(TT_BUF_RLEN(&buf), 0, "");
    }
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_parse)
{
    ...
    for (i = 0; i < sizeof(__sshmsg_parse_vec) / sizeof(__sshmsg_parse_vec[0]);
        ...
        // tt_sshmsg_parse
        if (TT_OK(ret)) {
            TT_UT_EQUAL(TT_BUF_RLEN(&buf), v->left_len, "");
    ...
    for (i = 0; i < 100; ++i) {
        ...
        ret = tt_sshmsg_parse(&buf, &msg);
        if (TT_OK(ret)) { tt_sshmsg_release(msg); }
    }
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_disconnect)
{
    ...
    TT_UT_EQUAL(out_msg->msg_id, TT_SSH_MSGID_DISCONNECT, "");
    msg_dis = TT_SSHMSG_CAST(out_msg, tt_sshmsg_disconnect_t);

    TT_UT_EQUAL(msg_dis->reason_code, 0x234, "");
    TT_UT_EQUAL(tt_strlen(msg_dis->description), TT_SSHMSG_DISC_DESC_LEN, "");
    TT_UT_EQUAL(tt_strncmp(msg_dis->description,
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_ignore)
{
    ...
    TT_UT_EQUAL(msg_ign->data.addr, NULL, "");
    TT_UT_EQUAL(msg_ign->data.len, 0, "");
    ...
    TT_UT_EQUAL(out_msg->msg_id, TT_SSH_MSGID_IGNORE, "");
...
TT_TEST_ROUTINE_DEFINE(case_sshms_newkeys)
{
    ...
    ret = tt_sshmsg_parse(&msg->buf, &out_msg);
    TT_UT_SUCCESS(ret, "");
    TT_UT_EQUAL(msg->msg_id, TT_SSH_MSGID_NEWKEYS, "");
    tt_buf_restore_rwp(&msg->buf, &rp, &wp);
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_servreq)
{
    ...
    TT_UT_NOT_EQUAL(msg, NULL, "");
    TT_UT_EQUAL(msg->msg_id, TT_SSH_MSGID_SERVICE_REQUEST, "");
    ...
    TT_UT_EQUAL(tt_sshmsg_servreq_get_service(msg), TT_SSH_SERVICE_USERAUTH,
                "");
    ...
    TT_UT_EQUAL(tt_sshmsg_servreq_get_service(msg), TT_SSH_SERVICE_CONNECTION,
                "");
...
TT_TEST_ROUTINE_DEFINE(case_sshmsg_servacc)
{
    ...
    TT_UT_NOT_EQUAL(msg, NULL, "");
    TT_UT_EQUAL(msg->msg_id, TT_SSH_MSGID_SERVICE_ACCEPT, "");
    ...
    TT_UT_EQUAL(tt_sshmsg_servacc_get_service(msg), TT_SSH_SERVICE_USERAUTH,
                "");
    ...
    TT_UT_EQUAL(tt_sshmsg_servacc_get_service(msg), TT_SSH_SERVICE_CONNECTION,
                "");
