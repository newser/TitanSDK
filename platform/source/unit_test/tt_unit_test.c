...
TT_TEST_UNIT_DECLARE(TEST_UNIT_BASIC_ALG)
TT_TEST_UNIT_DECLARE(TEST_UNIT_MUTEX)
TT_TEST_UNIT_DECLARE(TEST_UNIT_SEM)
TT_TEST_UNIT_DECLARE(TEST_UNIT_RWLOCK)
TT_TEST_UNIT_DECLARE(TEST_UNIT_MEMOS)
TT_TEST_UNIT_DECLARE(TEST_UNIT_SLAB)
TT_TEST_UNIT_DECLARE(TEST_UNIT_MISC)
TT_TEST_UNIT_DECLARE(TEST_UNIT_STAMP_PTR)
TT_TEST_UNIT_DECLARE(TEST_UNIT_MEMPOOL)
TT_TEST_UNIT_DECLARE(TEST_UNIT_PGCENTER)
TT_TEST_UNIT_DECLARE(TEST_UNIT_BINCENTER)
TT_TEST_UNIT_DECLARE(TEST_UNIT_THREAD_CACHE)
TT_TEST_UNIT_DECLARE(TEST_UNIT_SLAB)
TT_TEST_UNIT_DECLARE(TEST_UNIT_TIME_REF)
TT_TEST_UNIT_DECLARE(TEST_UNIT_HEAP)
TT_TEST_UNIT_DECLARE(TEST_UNIT_FS)
TT_TEST_UNIT_DECLARE(TEST_UNIT_TIMER_MGR)
TT_TEST_UNIT_DECLARE(TEST_UNIT_SOCKET)
TT_TEST_UNIT_DECLARE(TEST_UNIT_EVPOLLER)
TT_TEST_UNIT_DECLARE(TEST_UNIT_BUF)
TT_TEST_UNIT_DECLARE(TEST_UNIT_IPC)
TT_TEST_UNIT_DECLARE(TEST_UNIT_CHARSET)
TT_TEST_UNIT_DECLARE(TEST_UNIT_STRING)
...
TT_TEST_UNIT_DECLARE(TEST_UNIT_VECTOR)
TT_TEST_UNIT_DECLARE(TEST_UNIT_LIST)
TT_TEST_UNIT_DECLARE(TEST_UNIT_MAP)
TT_TEST_UNIT_DECLARE(TEST_UNIT_QUEUE)
TT_TEST_UNIT_DECLARE(TEST_UNIT_RBTREE)
...
tt_test_unit_t *tt_g_test_unit_list[TEST_UNIT_NUM] = {
    ...
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_LIST),
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_BUF),
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_STRING),
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_VECTOR),
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_HEAP),
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_MAP),
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_QUEUE),
#endif
    &TT_MAKE_TEST_UNIT_NAME(TEST_UNIT_RBTREE),
