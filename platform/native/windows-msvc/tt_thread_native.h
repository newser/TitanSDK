...
extern DWORD tt_g_thread_fls_index;
...
initialize ts thread ntv system
...
/**
@fn tt_thread_ntv_t *tt_current_thread_ntv()
...
{
    return (struct tt_thread_s *)FlsGetValue(tt_g_thread_fls_index);
}
