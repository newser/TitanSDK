...
tt_export tt_bool_t tt_buf_startwith(IN tt_buf_t *buf, IN tt_u8_t *p,
                                     IN tt_u32_t len);
...
tt_export tt_bool_t tt_buf_endwith(IN tt_buf_t *buf, IN tt_u8_t *p,
                                   IN tt_u32_t len);
...
tt_export void tt_buf_remove_range(IN tt_buf_t *buf, IN tt_u32_t from,
                                   IN tt_u32_t to);
...
tt_export tt_result_t tt_buf_insert(IN tt_buf_t *buf, IN tt_u32_t idx,
                                    IN tt_u8_t *data, IN tt_u32_t data_len);

tt_inline tt_result_t tt_buf_insert_cstr(IN tt_buf_t *buf, IN tt_u32_t idx,
                                         IN const tt_char_t *cstr)
{
    return tt_buf_insert(buf, idx, (tt_u8_t *)cstr, (tt_u32_t)tt_strlen(cstr));
}

tt_export tt_result_t tt_buf_tok(IN tt_buf_t *buf, IN tt_u8_t *sep,
                                 IN tt_u32_t sep_num, IN tt_u32_t flag,
                                 OUT tt_u8_t **last, OUT tt_u32_t *last_len);
// flag
