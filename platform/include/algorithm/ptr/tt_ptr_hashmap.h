...
typedef tt_bool_t (*tt_ptrhmap_action_t)(IN tt_u8_t *key, IN tt_u32_t key_len,
                                         IN tt_ptr_t ptr, IN void *param);
...
tt_export tt_ptr_t tt_ptrhmap_find(IN tt_ptrhmap_t *phm, IN tt_u8_t *key,
                                   IN tt_u32_t key_len);
...
tt_export tt_result_t tt_ptrhmap_add(IN tt_ptrhmap_t *phm, IN tt_u8_t *key,
                                     IN tt_u32_t key_len, IN tt_ptr_t ptr);

tt_export tt_bool_t tt_ptrhmap_remove_key(IN tt_ptrhmap_t *phm, IN tt_u8_t *key,
                                          IN tt_u32_t key_len);
...
tt_export tt_bool_t tt_ptrhmap_replace(IN tt_ptrhmap_t *phm, IN tt_u8_t *key,
                                       IN tt_u32_t key_len,
                                       IN tt_ptr_t new_ptr);
