...
extern void tt_ptrheap_init(IN tt_ptrheap_t *ph,
                            IN OPT tt_cmp_t cmp,
                            IN OPT tt_ptrheap_attr_t *attr);

extern void tt_ptrheap_destroy(IN tt_ptrheap_t *ph);

extern void tt_ptrheap_attr_default(IN tt_ptrheap_attr_t *attr);

extern tt_result_t __ptrheap_reserve(IN tt_ptrheap_t *ph, IN tt_u32_t count);
...
extern void tt_ptrheap_fix(IN tt_ptrheap_t *ph, IN tt_u32_t idx);
...
extern void tt_ptrheap_clear(IN tt_ptrheap_t *ph);

// - the value of returned idx could be used as a key to query
//   the entry in ph, i.e. passing to tt_ptrheap_remove() to remove
//   the inserted entry
extern tt_result_t tt_ptrheap_add(IN tt_ptrheap_t *ph,
                                  IN tt_ptr_t p,
                                  OUT tt_u32_t *idx);

extern void tt_ptrheap_remove(IN tt_ptrheap_t *ph, IN tt_u32_t idx);

extern tt_bool_t tt_ptrheap_contain(IN tt_ptrheap_t *ph, IN tt_ptr_t p);
...
*/
extern tt_ptr_t tt_ptrheap_pop(IN tt_ptrheap_t *ph);
