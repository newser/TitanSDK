...
// test
//#define __SIMULATE_IPC_AIO_FAIL
...
// todo: new_ipc should be destroyed by tt_async_ipc_destroy once
...
extern tt_result_t tt_ipc_iocp_handler(IN struct tt_ipc_s *ipc,
