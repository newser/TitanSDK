...
// NOTE even these API do not behave same on different platform,
// tt_snprintf is an example
...
extern int tt_vsnprintf(char *str, size_t size, const char *format, va_list ap);
