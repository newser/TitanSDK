...
{
    // tt_u32_t param = TT_TEST_ROUTINE_PARAM(tt_u32_t);
    tt_param_t *root, *g1, *g11, *g12, *g121, *c1211;
    tt_u32_t val = 0;
    tt_param_t *n;
    tt_string_t path;
    ...
    root = tt_param_dir_create("", NULL);
    TT_UT_NOT_EQUAL(root, NULL, "");
    g1 = tt_param_dir_create("g1", NULL);
    TT_UT_NOT_EQUAL(g1, NULL, "");
    g11 = tt_param_dir_create("g11", NULL);
    TT_UT_NOT_EQUAL(g11, NULL, "");
    g12 = tt_param_dir_create("g12", NULL);
    TT_UT_NOT_EQUAL(g12, NULL, "");
    g121 = tt_param_dir_create("g121", NULL);
    TT_UT_NOT_EQUAL(g121, NULL, "");
    c1211 = tt_param_u32_create("c1211", &val, NULL, NULL);
    TT_UT_NOT_EQUAL(g121, NULL, "");
    ...
    // null path
    n = tt_param_path_p2n_cstr(root, root, "");
    TT_UT_EQUAL(n, NULL, "");

    // invalid current
    n = tt_param_path_p2n_cstr(c1211, root, "/");
    TT_UT_EQUAL(n, NULL, "");
    ...
    // invalid path
    n = tt_param_path_p2n_cstr(root, root, "/g");
    TT_UT_EQUAL(n, NULL, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, root, "/g1");
    TT_UT_EQUAL(n, g1, "");
    ...
    // invalid path
    n = tt_param_path_p2n_cstr(root, root, "/g1/g1");
    TT_UT_EQUAL(n, NULL, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, root, "/g1/g11");
    TT_UT_EQUAL(n, g11, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, root, "/g1/g12/");
    TT_UT_EQUAL(n, g12, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, root, "/g1/g12/g121/c1211");
    TT_UT_EQUAL(n, c1211, "");

    // invalid path
    n = tt_param_path_p2n_cstr(root, root, "/g1/g12xx/g121/c1211");
    TT_UT_EQUAL(n, NULL, "");

    // invalid path
    n = tt_param_path_p2n_cstr(root, root, "/g1xx/g12/g121/c1211");
    TT_UT_EQUAL(n, NULL, "");

    // invalid path
    n = tt_param_path_p2n_cstr(root, root, "/g1/g12/g121xx/c1211");
    TT_UT_EQUAL(n, NULL, "");

    // valid path
    n = tt_param_path_p2n_cstr(g12, g12, "/g121/c1211");
    TT_UT_EQUAL(n, c1211, "");

    // valid path
    n = tt_param_path_p2n_cstr(g1, g1, "/g12/g121/");
    TT_UT_EQUAL(n, g121, "");
...
TT_TEST_ROUTINE_DEFINE(case_cfgpath_p2n_rel)
{
    ...
    // invalid path
    n = tt_param_path_p2n_cstr(root, c1211, ".");
    TT_UT_EQUAL(n, NULL, "");
    ...
    // invalid path
    n = tt_param_path_p2n_cstr(root, g1, "g1");
    TT_UT_EQUAL(n, NULL, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g1, "g11");
    TT_UT_EQUAL(n, g11, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g1, "g12/");
    TT_UT_EQUAL(n, g12, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g1, "g12/g121/c1211");
    TT_UT_EQUAL(n, c1211, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g12, "g121/c1211");
    TT_UT_EQUAL(n, c1211, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g12, "g121/../g121/./c1211");
    TT_UT_EQUAL(n, c1211, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g12, "g121/../g121/.");
    TT_UT_EQUAL(n, g121, "");
...
TT_TEST_ROUTINE_DEFINE(case_cfgpath_p2n_dot)
{
    ...
    // valid path
    n = tt_param_path_p2n_cstr(root, root, "./g1/../g1/g12/../../g1");
    TT_UT_EQUAL(n, g1, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, g12, "./../../g1");
    TT_UT_EQUAL(n, g1, "");

    // valid path
    n = tt_param_path_p2n_cstr(root, c1211, "/g1/g11");
    TT_UT_EQUAL(n, g11, "");
    ...
    // valid path
    n = tt_param_path_p2n_cstr(root, g121, "../../../g1/g12/g121/c1211");
    TT_UT_EQUAL(n, c1211, "");
    ...
    // valid path
    n = tt_param_path_p2n_cstr(root, g121, "../../../g1/g12/g121/../../../");
    TT_UT_EQUAL(n, root, "");
...
TT_TEST_ROUTINE_DEFINE(case_cfgpath_n2p)
{
    ...
    tt_buf_clear(&path);
    ret = tt_param_path_n2p(root, root, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(root, g1, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "g1");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(root, g121, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "g1/g12/g121");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(root, c1211, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    ...
    // not from root
    tt_buf_clear(&path);
    ret = tt_param_path_n2p(g1, c1211, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "g12/g121/c1211");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(g1, g121, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "g12/g121");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(g1, g1, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(g12, g12, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "");
    TT_UT_EQUAL(cmp_ret, 0, "");
    ...
    // not real root
    tt_buf_clear(&path);
    ret = tt_param_path_n2p(g11, g121, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "/g1/g12/g121");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(NULL, c1211, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "/g1/g12/g121/c1211");
    TT_UT_EQUAL(cmp_ret, 0, "");

    tt_buf_clear(&path);
    ret = tt_param_path_n2p(c1211, g121, &path);
    TT_UT_EQUAL(ret, TT_SUCCESS, "");
    cmp_ret = tt_buf_cmp_cstr(&path, "/g1/g12/g121");
    TT_UT_EQUAL(cmp_ret, 0, "");
